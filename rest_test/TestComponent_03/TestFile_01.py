"""
Generated Test File
Generated on: 2026-08-24 02:25:45
...
@allure.suite('TestComponent03TestFile01')
class TestComponent03TestFile01:
    """
    ...
    def test_01_create_a_new_pet_in_pest_store_ai(self, api_client):
        ...
        step2_endpoint = "/pet"
        update_payload = {
            "pet_id": extracted_pet_id,  # Use the pet_id from previous response
            "name": "Fluffy Updated",
            "status": "available"
        }
        ...
        step3_endpoint = f"/pet/{extracted_pet_id}"  # Use the pet_id from previous response
    ...
    def test_02_create_a_new_pet_in_pest_store_ai(self, api_client):
        ...
        with allure.step("Step 1: POST /pet"):
            ...
            response1 = api_client.post(
                endpoint=step1_endpoint,
                json_payload=payload  # Using json_payload for application/json
            )
        ...
        with allure.step("Step 2: PUT /pet"):
            ...
            response2 = api_client.put(
                endpoint=step2_endpoint,
                json_payload=update_payload  # Using json_payload for application/json
            )
        ...
        step3_endpoint = f"/pet/{extracted_pet_id}"  # Using the pet_id from previous response
